...
{
    /// <summary>
    /// Page model for various testing and demonstration tools
    /// </summary>
    public class ToolsModel : PageModel
    {
        /// <summary>
        /// Gets the message to display to the user after an action
        /// </summary>
        public string Message { get; private set; } = "";

        /// <summary>
        /// Multi purpose controller method for various testing actions
